<template>
    ...
    <div>
        <button
            class="flex justify-between items-center w-full py-3 font-semibold text-start text-gray-800 hover:text-gray-500 rounded-lg"
        ...
        <div v-if="filters.brand.open" class="overflow-hidden transition-[height] duration-300">
            <div v-if="brands.length > 0" v-for="brand in brands" :key="brand">
            <input
                type="checkbox"
                :value="brand"
    ...
    <div>
        ...
        <div v-if="filters.categories.open" class="overflow-hidden transition-[height] duration-300">
            <div v-if="categories.length > 0" v-for="category in categories" :key="category">
                <input
                    type="checkbox"
                    :value="category"
